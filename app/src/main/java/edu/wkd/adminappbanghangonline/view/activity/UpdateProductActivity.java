...
import edu.wkd.adminappbanghangonline.databinding.ActivityUpdateProductBinding;
...
public class UpdateProductActivity extends AppCompatActivity {
    ...
    private String image = "zzzzzzzzzzzzz";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ApiService.apiService.updateProduct(fileToUpload,45, name, price, description, productType, image).enqueue(new Callback<ProductResponse>() {
                    @Override
